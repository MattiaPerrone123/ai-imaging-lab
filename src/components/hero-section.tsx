      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <a href={`${import.meta.env.BASE_URL}Mattia_Perrone_Resume.pdf`} target="_blank" rel="noopener noreferrer">
            ...
            <Button size="default" className="border border-blue-600 bg-blue-100 text-blue-600 hover:bg-blue-200 px-4 lg:px-8 flex-1 md:flex-none w-full">
        ...
        <div className="flex justify-center md:justify-end">
          <div className="relative">
            <img
              src={headshotImage}
              alt="Mattia Perrone"
              className="w-[22rem] h-[26rem] object-cover rounded-3xl border border-border shadow-[0_20px_60px_-5px_rgba(59,130,246,0.5)] transition-transform duration-300 hover:scale-105 cursor-pointer"
            />
          </div>
        </div>
      </div>
